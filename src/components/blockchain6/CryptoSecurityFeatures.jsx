...
const securityFeatures = [
  { title: 'HTTP Authentication', description: 'We make sure to secure data with HTTP authentication.', icon: httpAuthIcon },
  { title: 'Data Encryption', description: 'Our cryptocurrency exchange software provides DDoS protection for your application.', icon: encryptionIcon },
  { title: 'Jail Login', description: 'To avoid multiple failed attempts for a certain amount of time & provide customer satisfaction.', icon: jailLoginIcon },
  { title: 'Anti Denial Of Service', description: 'Our cryptocurrency exchange software provides DDoS protection for your application.', icon: dosProtectionIcon },
  { title: 'Server-side request forgery prevention', description: 'Defend the exchange from overwhelming traffic originating from multiple sources.', icon: forgeryIcon },
  { title: 'Cross-Site Request Forgery prevention', description: 'To protect user credentials and encrypt all data.', icon: csrfIcon },
  { title: 'Anti-distributed denial of service (DDoS)', description: 'Avoid multiple failed attempts over time to provide satisfaction.', icon: ddosIcon },
  { title: 'HTTP Parameter Pollution Protection', description: 'Dissuades web attacks to retrieve confidential information.', icon: pollutionIcon },
];
  ...
  return (
    <section className={styles.cryptoSecuritySection}>
      <div className={styles.container}>
        <h2 className={styles.title}>High-Security Features Of Our Cryptocurrency Exchange Software Development</h2>
        ...
        <h3 className={styles.industryTitle}>One Solution, Usage In Multiple Industries</h3>
