...
const EmpoweringSection = () => {
  ...
  return (
    ...
    <section className={styles.featuresContainer}>
      ...
      <p>RisingMax Inc. offers end-to-end NFT development services for individuals and institutions to ensure total ownership of their digital assets. Get a versatile marketplace designed by our expert developers, where assets get tokenized for secure buying & selling and ensure digital asset ownership.</p>
      <div className={styles.featuresGrid}>
        {features.map((feature, index) => (
          <div key={index} className={styles.featureCard}>
            <div className={styles.icon}><img src={feature.icon} alt="" /></div>
    ...
    <section className={styles.techStackContainer}>
      <h2 className={styles.title}>Technology Stack We Deploy For Non Fungible Token Development</h2>
      <div className={styles.platformsGrid}>
        {platforms.map((platform, index) => (
          <div key={index} className={styles.platformCard}>
            <div className={styles.platformIcon}><img className={styles.platformImg} src={platform.icon} alt="" /></div>
          </div>
        ))}
      </div>
    </section>
